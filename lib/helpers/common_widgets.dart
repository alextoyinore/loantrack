...
Divider separatorLine = Divider(
    thickness: .5, color: LoanTrackColors.PrimaryTwoVeryLight.withOpacity(.3));

SizedBox separatorSpace10 = const SizedBox(height: 10);
SizedBox separatorSpace5 = const SizedBox(height: 5);
SizedBox separatorSpace20 = const SizedBox(height: 20);
SizedBox separatorSpace30 = const SizedBox(height: 30);
SizedBox separatorSpace40 = const SizedBox(height: 40);
SizedBox separatorSpace50 = const SizedBox(height: 50);
SizedBox separatorSpace80 = const SizedBox(height: 80);
